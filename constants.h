...
/*Consumption, values are per population*/
#define MIN_CEREAL_CONSUMPTION 3000
/*
...
*/
#define MIDDLE_INCOME_THRESHOLD 12000
#define UPPER_INCOME_THRESHOLD 30000

const int FOOD_TYPES[4];
const int BASIC_GOOD_TYPES[8];
const int LUXURY_GOOD_TYPES[6];
